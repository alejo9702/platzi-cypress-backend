describe('intercept', () => {
    ...
    it('simple intercept', function () {
        ...
        cy.wait("@bulbasaur", {timeout: 5000}).then(interception => {
    ...
    it.only("Test changing the body from the intercept",
        function () {
            cy.intercept("GET",
            ...
            cy.contains("Pikachu").parent().parent().within((element) => {
                cy.wrap(element).contains("Más detalles").click();
            });
